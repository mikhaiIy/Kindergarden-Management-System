...
if( mysqli_num_rows($resultVAK)>0){
    header("location:updatevakassessmentfk.php?id=".$aid);
}
if(mysqli_num_rows($resultINT)>0) {
    header("location:updateintelligentassessmentfk.php?id=".$aid);
}
if(mysqli_num_rows($resultSUB)>0) {
    header("location:updatesubjectassessmentfk.php?id=".$aid);
}
