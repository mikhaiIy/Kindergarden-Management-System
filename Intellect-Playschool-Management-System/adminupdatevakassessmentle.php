...
$sqlv="SELECT * FROM academic_le_vak WHERE acad_ID = '$aid'";
...
<div class="d-sm-flex justify-content-between align-items-center mb-4">
        ...
        <form action="adminupdatevakassessmentleprocess.php" method="post">
    ...
    <?php
    $resultv = mysqli_query($con, "SELECT * FROM academic_le_vak WHERE acad_ID='$aid'");
    if (mysqli_num_rows($resultv) > 0) {
        while ($row = mysqli_fetch_array($resultv)) {
            if ($row['acad_VAKType'] == 1) {
                ...
                echo '<td><textarea type="text" class="form-control" style="white-space: normal;" style="width: fit-content;" style="height: fit-content;" name="acad_VAKComm_V" placeholder="' . $row['acad_VAKComm'] . '"></textarea></td>';
                echo '<td></td>';
                echo '<td></td>';
                echo '</tr>';
                ...
                echo '<td></td>';
                echo '<td><textarea type="text" class="form-control" style="white-space: normal;" style="width: fit-content;" style="height: fit-content;" name="acad_VAKComm_A" placeholder="' . $row['acad_VAKComm'] . '"></textarea></td>';
                echo '<td></td>';
                echo '</tr>';
                ...
                echo '<td></td>';
                echo '<td></td>';
                echo '<td><textarea type="text" class="form-control" style="white-space: normal;" style="width: fit-content;" style="height: fit-content;" name="acad_VAKComm_K" placeholder="' . $row['acad_VAKComm'] . '"></textarea></td>';
                echo '</tr>';
                ...
                foreach ($result2 as $row1) {
                    if ($row1['description'] == "Catatan/Komen") {
                        ...
                        echo '<td><textarea type="text" class="form-control" style="white-space: normal;" style="width: fit-content;" style="height: fit-content;" name="acad_VAKComm_C" placeholder="' . $row['acad_VAKComm'] . '"></textarea></td>';
                    }
