...
<table cellspacing="0" style="table-layout: fixed;" style="word-wrap: break-word;" width="100%">
            ...
            <tr>
              ...
              <td><textarea type="text" class="form-control" style="white-space: normal;" style="width: fit-content;" style="height: fit-content;" name="acad_IntelliComm1" id="acad_IntelliComm" placeholder="Leave a comment"></textarea></td> 
            </tr>

            <tr>
              <!-- Yang ni nanti akan connect ngan database untuk retrieve VAKType -->
              <td style="text-align:left">Kecerdasan Logik (Matematik)</td>
              <td><textarea type="text" class="form-control" style="white-space: normal;" style="width: fit-content;" style="height: fit-content;" name="acad_IntelliComm2" id="acad_IntelliComm" placeholder="Leave a comment"></textarea></td>
            </tr>

            <tr>
              <!-- Yang ni nanti akan connect ngan database untuk retrieve VAKType -->
              <td style="text-align:left">Kecerdasan Muzikal</td>
              <td><textarea type="text" class="form-control" style="white-space: normal;" style="width: fit-content;" style="height: fit-content;" name="acad_IntelliComm3" id="acad_IntelliComm" placeholder="Leave a comment"></textarea></td> 
            </tr>
            
            <tr>
              <!-- Yang ni nanti akan connect ngan database untuk retrieve VAKType -->
              <td style="text-align:left">Kecerdasan Visual (Spatial)</td>
              <td><textarea type="text" class="form-control" style="white-space: normal;" style="width: fit-content;" style="height: fit-content;" name="acad_IntelliComm4" id="acad_IntelliComm" placeholder="Leave a comment"></textarea></td> 
            </tr>

            <tr>
              <!-- Yang ni nanti akan connect ngan database untuk retrieve VAKType -->
              <td style="text-align:left">Kecerdasan Kinestetik (Badan)</td>
              <td><textarea type="text" class="form-control" style="white-space: normal;" style="width: fit-content;" style="height: fit-content;" name="acad_IntelliComm5" id="acad_IntelliComm" placeholder="Leave a comment"></textarea></td> 
            </tr>

            <tr>
              <!-- Yang ni nanti akan connect ngan database untuk retrieve VAKType -->
              <td style="text-align:left">Kecerdasan Interpersonal</td>
              <td><textarea type="text" class="form-control" style="white-space: normal;" style="width: fit-content;" style="height: fit-content;" name="acad_IntelliComm6" id="acad_IntelliComm" placeholder="Leave a comment"></textarea></td> 
            </tr>

            <tr>
              <!-- Yang ni nanti akan connect ngan database untuk retrieve VAKType -->
              <td style="text-align:left">Kecerdasan Intrapersonal</td>
              <td><textarea type="text" class="form-control" style="white-space: normal;" style="width: fit-content;" style="height: fit-content;" name="acad_IntelliComm7" id="acad_IntelliComm" placeholder="Leave a comment"></textarea></td> 
            </tr>

            <tr>
              <!-- Yang ni nanti akan connect ngan database untuk retrieve VAKType -->
              <td style="text-align:left">Kecerdasan Naturalis</td>
              <td><textarea type="text" class="form-control" style="white-space: normal;" style="width: fit-content;" style="height: fit-content;" name="acad_IntelliComm8" id="acad_IntelliComm" placeholder="Leave a comment"></textarea></td> 
            </tr>

            <tr>
              <!-- Yang ni nanti akan connect ngan database untuk retrieve VAKType -->
              <td style="text-align:left">Kecerdasan Existentialis</td>
              <td><textarea type="text" class="form-control" style="white-space: normal;" style="width: fit-content;" style="height: fit-content;" name="acad_IntelliComm9" id="acad_IntelliComm" placeholder="Leave a comment"></textarea></td> 
            </tr>
        </table>
<br>
