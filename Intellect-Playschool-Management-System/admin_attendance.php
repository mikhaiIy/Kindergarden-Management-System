    ...
    <div class="d-flex flex-column" id="content-wrapper">
        <div id="content">
            ...
            <div class="container-fluid">
                <h3 class="text-dark mb-1">Welcome to Attendance Menu, <?php echo $_SESSION['firstName']?></h3>
            </div>
            <div class="container">
                <a class="btn btn-primary" role="button" data-bss-hover-animate="pulse" href="admin_attendance_view.php" style="width: 249px;height: 141px;margin: 19px;padding: 51px 12px;">View Staff Attendance</a>
                <a class="btn btn-primary" role="button" data-bss-hover-animate="pulse" href="admin_confirm.php" style="width: 249px;height: 141px;margin: 19px;padding: 45px 12px;color: var(--bs-black);background: var(--bs-warning);">Confirm Student Daily Attendance</a>
                <a class="btn btn-primary" role="button" data-bss-hover-animate="pulse" href="admin2_attendance_view.php" style="width: 249px;height: 141px;margin: 19px;padding: 51px 12px;color: var(--bs-black);background: var(--bs-warning);">View Student Attendance</a>
            </div>
        </div>
