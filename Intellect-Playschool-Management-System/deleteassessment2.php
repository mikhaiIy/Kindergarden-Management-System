            ...
            <div class="row"><div class="col-lg-7 col-xl-8"><div class="card shadow mb-4">
                ...
                if($acad_Prog == 1){
                    while($row=mysqli_fetch_array($resultle)){
                        ...
                        echo "<td>";
                        echo "<a href='deleteassessmentleprocess.php?id=".$row['acad_ID']."' class='btn btn-danger'>Delete</a>";
                        echo "</td>";
                        echo '</tr>';
                    }
                    ...
                    while($row=mysqli_fetch_array($resultfk)){
                        ...
                        echo "<td>".$row['acad_CommStat']."</td>";
                        echo "<td>";
                        echo "<a href='deleteassessmentfkprocess.php?id=".$row['acad_ID']."' class='btn btn-danger'>Delete</a>";
                        echo "</td>";
                        echo '</tr>';
                    }
                }
