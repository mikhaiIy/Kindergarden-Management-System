                                                ...
                                                <table class="table table-striped table-sm my-0 mydatatable">
                                                    ...
                                                    while ($row = mysqli_fetch_array($result)) {
                                                        ...
                                                        echo '<td> <form method="POST" action="salary_print.php" target="_blank" style="display: inline-block;">
                                                                    ...
                                                                    <button type="button" class="btn btn-danger" onclick="confirmDelete('.$row['acc_ID'].')">Delete</button></td>';
                                                        echo "</tr>";
                                                    }
                                                    ?>
                                                    </tbody>
...
<script>
              function confirmDelete(acc_ID) {
                Swal.fire({
                  ...
                  if (result.value) {
                    window.location.href = 'admin_salarydeleteprocess.php?acc_ID=' + acc_ID;
                  }
                });
