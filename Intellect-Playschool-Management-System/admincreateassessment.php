...
<!--                <li class="nav-item"><a class="nav-link" href="admin_profile.php"><i class="fas fa-user"></i><span>Profile</span></a></li>-->
    ...
    <div class="d-flex flex-column" id="content-wrapper">
        <div id="content">
            ...
            <form action="admincreateassessmentprocess.php" method="post">

              <div class="form-group row">
                <div class="col-md-12">
                  <label for="exampleInputPassword1" class="form-label mt-4">Program</label>
                    <select id="fee_Program" name="acad_Prog" class="fee_Program form-select"  required>
              ...
              <div class="form-group row">
                <div class="col-md-12">
                  <label for="exampleInputPassword1" class="form-label mt-4">Student</label>
                    <select id="student" name="s_ID" class="student form-select" onchange="selectFee()"  required>
              ...
              <div class="form-group row">
                <div class="col-md-12">
                  <label for="exampleInputPassword1" class="form-label mt-4">Assessment Status</label>
                  <?php
                $sql2 = "SELECT * FROM academic_commstat_desc";
                $result2 = mysqli_query($con,$sql2);
                echo '<select class="form-select" name="acad_CommStat" id="exampleSelect1">';
			      		while($row2 = mysqli_fetch_array($result2))
			      		{
			      			echo"<option value = '".$row2['acad_CommStat']."'>".$row2['description']."</option>";
			      		}
			      	echo '</select>';
                ?>
                </div>
              ...
              <div class="form-group row">
                <div class="col-md-12">
                    <label for="exampleInputPassword1"  class="form-label mt-4">Assessment Type</label>
                    <select class="assessmentType form-select" id="assessmentType" name="acad_assessmenttype">
                        <option hidden disabled selected value> -- select a program first -- </option>
                    </select>
                </div>
              </div>
              ...
              <div class="form-group row">
                <div class="col-md-12">
                    <label for="exampleInputPassword1" class="form-label mt-4">Today's Date</label>
                    <input type="date" class="form-control" name="acad_CommDate" id="exampleInputPassword1" placeholder="dd/mm/yyyy" required>
                    <br>
                </div>
              </div>
    ...
    <div class="card-body">
    <h2 class="text-black mb-4">Create new assessment for a student.</h2>
    ...
    <ol>
        ...
        <li><span class="d-block text-black">For both programs, you need to choose either it is a weekly assessment or a summary assessment.</span></li>
        <li><span class="d-block text-black">Select which type of assessment.</span></li>
        <li><span class="d-block text-black">Enter today&#39;s date.</span></li>
