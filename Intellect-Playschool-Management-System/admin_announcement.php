...
<div id="wrapper">
    <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
        <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="index.php">
            ...
            <ul class="navbar-nav text-light" id="accordionSidebar">
                ...
                <li class="nav-item"><a class="nav-link active" href="admin_announcement.php"><i class="far fa-user-circle"></i><span>Announcement</span></a></li>
    ...
    <div class="d-flex flex-column" id="content-wrapper">
        <div id="content">
                ...
                <div class="row gy-4 row-cols-1 row-cols-md-2 row-cols-xl-3">
                    ...
                    while($row = mysqli_fetch_array($result))
                    {
                        ...
                        if(($row["announce_Type"] == '1') && ($row["announce_Category"] == '0' || $row["announce_Category"] == '1' || $row["announce_Category"] == '2' ))
                        {
                            ...
                            echo' <button style="margin-right: 10px; " class="btn btn-warning" value="Submit" type="button" onclick="location.href=\'modifyannouncement.php?aa_id='.$row['announce_ID'].'\'">Modify</button>';
                            echo'</div>';
                            echo'</form>';
                            echo'</div>';
                            echo'</div>';
            ...
            <?php include('createAnnmodal.php'); ?>
            <script>
                function confirmDelete(aa_id) {
                    Swal.fire({
                        ...
                        if (result.value) {
                            window.location.href = 'deleteannouncement.php?aa_id=' + aa_id;
                        }
                    });
