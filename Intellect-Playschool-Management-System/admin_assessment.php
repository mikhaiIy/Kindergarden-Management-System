                ...
                <div class="row"><div class="col-lg-7 col-xl-8"><div class="card shadow mb-4">
                            <div class="card-body">
                                <div class="container">
                                    ...
                                    <a class="btn btn-primary" role="button" href="admincreateassessment.php" style="width:200px;height:235px;margin:28px;padding:100px 12px;color:var(--bs-btn-color);background:var(--bs-purple);text-align:center;">Create Assessment</a>
                                    <a class="btn btn-primary" role="button" href="admineditassessment.php" style="width: 200px;height: 235px;margin: 28px;padding: 100px 12px;color: var(--bs-btn-color);background: var(--bs-purple);">Edit Assessment</a>
                                    <a class="btn btn-primary" role="button" href="adminviewassessment.php" style="width:200px;height:235px;margin:28px;padding:100px 12px;color:var(--bs-btn-color);background:var(--bs-purple);">View Assessment</a>
                                    <a class="btn btn-primary" role="button" href="admindeleteassessment.php" style="width:200px;height:235px;margin:28px;padding:100px 12px;color:var(--bs-btn-color);background:var(--bs-purple);">Delete Assessment</a>
