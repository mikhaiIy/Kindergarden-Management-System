        ...
        <br>
            ...
            <table cellspacing="0" style="table-layout: fixed;" style="word-wrap: break-word;" width="100%">
                          ...
                          <?php
                            ...
                            $resultv = mysqli_query($con, "SELECT * FROM academic_fk_subject WHERE acad_ID='$aid'");
                          while ($row = mysqli_fetch_array($resultv)) {
                            echo '<tr>';
                              if ($row['acad_SubName'] == 1) {
                                 
                                  echo '<td name="acad_SubName1">' . "Bahasa Melayu" . '</td>';
                                  if ($row['acad_SubName'] == 1 && $row['acad_SubNameType'] == 1) {
                                      $sql1 = "SELECT * FROM academic_subcomm_desc";
                                      $result1 = mysqli_query($con, $sql1);
                                      echo '<td><select class="form-select" name="acad_SubComm10" id="exampleSelect1" placeholder="' . $row['acad_SubComm'] . '">';
                                      while ($row1 = mysqli_fetch_array($result1)) {
                                          echo "<option value = '" . $row1['acad_SubComm'] . "'>" . $row1['acad_SubComm'] . " : " . $row1['description'] . "</option>";
                                      }
                                      echo '</select></td>';
                                  }
                                  /*if ($row['acad_SubNameType'] == 2) {
                                      $sql2 = "SELECT * FROM academic_subcomm_desc";
                                      $result2 = mysqli_query($con, $sql2);
                                      echo '<td><select class="form-select" name="acad_SubComm20" id="exampleSelect1" placeholder="' . $row['acad_SubComm'] . '">';
                                      while ($row1 = mysqli_fetch_array($result2)) {
                                          echo "<option value = '" . $row1['acad_SubComm'] . "'>" . $row1['acad_SubComm'] . " : " . $row1['description'] . "</option>";
                                      }
                                      echo '</select></td>';
                                  }
                                  if ($row['acad_SubNameType'] == 3) {
                                      $sql3 = "SELECT * FROM academic_subcomm_desc";
                                      $result3 = mysqli_query($con, $sql3);
                                      echo '<td><select class="form-select" name="acad_SubComm30" id="exampleSelect1" placeholder="' . $row['acad_SubComm'] . '">';
                                      while ($row1 = mysqli_fetch_array($result3)) {
                                          echo "<option value = '" . $row1['acad_SubComm'] . "'>" . $row1['acad_SubComm'] . " : " . $row1['description'] . "</option>";
                                      }
                                      echo '</select></td>';
                                  }
                                  if ($row['acad_SubNameType'] == 4) {
                                      $sql4 = "SELECT * FROM academic_subcomm_desc";
                                      $result4 = mysqli_query($con, $sql4);
                                      echo '<td><select class="form-select" name="acad_SubComm40" id="exampleSelect1" placeholder="' . $row['acad_SubComm'] . '">';
                              ...
                              /*else if ($row['acad_SubName'] == 2) {
                              echo '<tr>';
                              echo '<td name="acad_SubName2">' . "Bahasa Inggeris" . '</td>';
                                  if ($row['acad_SubNameType'] == 1) {
                                      $sql5 = "SELECT * FROM academic_subcomm_desc";
                                      $result5 = mysqli_query($con, $sql5);
                                      echo '<td><select class="form-select" name="acad_SubComm11" id="exampleSelect1" placeholder="' . $row['acad_SubComm'] . '">';
                                      while ($row = mysqli_fetch_array($result5)) {
                                          echo "<option value = '" . $row['acad_SubComm'] . "'>" . $row['acad_SubComm'] . " : " . $row['description'] . "</option>";
                                      }
                                      echo '</select></td>';
                                  } else if ($row['acad_SubNameType'] == 2) {
                              $sql6 = "SELECT * FROM academic_subcomm_desc";
                              $result6 = mysqli_query($con, $sql6);
                              echo '<td><select class="form-select" name="acad_SubComm21" id="exampleSelect1" placeholder="' . $row['acad_SubComm'] . '">';
                              while ($row = mysqli_fetch_array($result6)) {
                                  echo "<option value = '" . $row['acad_SubComm'] . "'>" . $row['acad_SubComm'] . " : " . $row['description'] . "</option>";
                              }
                              echo '</select></td>';
                            } else if ($row['acad_SubNameType'] == 3) {
                              $sql7 = "SELECT * FROM academic_subcomm_desc";
                              $result7 = mysqli_query($con, $sql7);
                              echo '<td><select class="form-select" name="acad_SubComm31" id="exampleSelect1" placeholder="' . $row['acad_SubComm'] . '">';
                              while ($row = mysqli_fetch_array($result7)) {
                                  echo "<option value = '" . $row['acad_SubComm'] . "'>" . $row['acad_SubComm'] . " : " . $row['description'] . "</option>";
                              }
                              echo '</select></td>';
                                  } else if ($row['acad_SubNameType'] == 4) {
                                      $sql8 = "SELECT * FROM academic_subcomm_desc";
                                      $result8 = mysqli_query($con, $sql8);
                                      echo '<td><select class="form-select" name="acad_SubComm41" id="exampleSelect1" placeholder="' . $row['acad_SubComm'] . '">';
                            ...
                            else if ($row['acad_SubName'] == 3) {
                              echo '<tr>';
                              echo '<td name="acad_SubName3">' . "Bahasa Arab" . '</td>';
                              if ($row['acad_SubNameType'] == 1) {
                              $sql9 = "SELECT * FROM academic_subcomm_desc";
                              $result9 = mysqli_query($con, $sql9);
                              echo '<td><select class="form-select" name="acad_SubComm12" id="exampleSelect1" placeholder="' . $row['acad_SubComm'] . '">';
                              ...
                              echo '<td><select class="form-select" name="acad_SubComm22" id="exampleSelect1" placeholder="' . $row['acad_SubComm'] . '">';
                              ...
                              echo '<td><select class="form-select" name="acad_SubComm32" id="exampleSelect1" placeholder="' . $row['acad_SubComm'] . '">';
                              ...
                              echo '</select></td>';
                                      ...
                                      echo '<td><select class="form-select" name="acad_SubComm42" id="exampleSelect1" placeholder="' . $row['acad_SubComm'] . '">';
                              ...
                              echo '</tr>';
                            ...
                            else if ($row['acad_SubName'] == 4) {
                                  echo '<tr>';
                                  echo '<td name="acad_SubName4">' . "Matematik" . '</td>';
                                  if ($row['acad_SubNameType'] == 1) {
                                  $sql13 = "SELECT * FROM academic_subcomm_desc";
                                  $result13 = mysqli_query($con, $sql13);
                                  echo '<td><select class="form-select" name="acad_SubComm13" id="exampleSelect1" placeholder="' . $row['acad_SubComm'] . '">';
                                  ...
                                  echo '<td><select class="form-select" name="acad_SubComm23" id="exampleSelect1" placeholder="' . $row['acad_SubComm'] . '">';
                                  ...
                                  echo '<td><select class="form-select" name="acad_SubComm33" id="exampleSelect1" placeholder="' . $row['acad_SubComm'] . '">';
                                  ...
                                  echo '</select></td>';
                                      ...
                                      echo '<td><select class="form-select" name="acad_SubComm43" id="exampleSelect1" placeholder="' . $row['acad_SubComm'] . '">';
                              ...
                              else if ($row['acad_SubName'] == 5) {
                                  echo '<tr>';
                                  echo '<td name="acad_SubName5">' . "Sains" . '</td>';
                                  if ($row['acad_SubNameType'] == 1) {
                                  $sql17 = "SELECT * FROM academic_subcomm_desc";
                                  $result17 = mysqli_query($con, $sql17);
                                  echo '<td><select class="form-select" name="acad_SubComm14" id="exampleSelect1" placeholder="' . $row['acad_SubComm'] . '">';
                                  ...
                                  echo '<td><select class="form-select" name="acad_SubComm24" id="exampleSelect1" placeholder="' . $row['acad_SubComm'] . '">';
                                  ...
                                  echo '<td><select class="form-select" name="acad_SubComm34" id="exampleSelect1" placeholder="' . $row['acad_SubComm'] . '">';
                                  ...
                                  echo '</select></td>';
                                      ...
                                      echo '<td><select class="form-select" name="acad_SubComm44" id="exampleSelect1" placeholder="' . $row['acad_SubComm'] . '">';
                              ...
                              else if ($row['acad_SubName'] == 6) {
                                  echo '<tr>';
                                  echo '<td name="acad_SubName6">' . "Arts & Craft" . '</td>';
                                  if ($row['acad_SubNameType'] == 1) {
                                  $sql21 = "SELECT * FROM academic_subcomm_desc";
                                  $result21 = mysqli_query($con, $sql21);
                                  echo '<td><select class="form-select" name="acad_SubComm15" id="exampleSelect1" placeholder="' . $row['acad_SubComm'] . '">';
                                  ...
                                  echo '<td><select class="form-select" name="acad_SubComm25" id="exampleSelect1" placeholder="' . $row['acad_SubComm'] . '">';
                                  ...
                                  echo '<td><select class="form-select" name="acad_SubComm35" id="exampleSelect1" placeholder="' . $row['acad_SubComm'] . '">';
                                  ...
                                  echo '</select></td>';
                                      ...
                                      echo '<td><select class="form-select" name="acad_SubComm45" id="exampleSelect1" placeholder="' . $row['acad_SubComm'] . '">';
