...
//JOIN student ON academic_le.s_ID = student.s_ID
//WHERE student.acc_ID = '$accID' ";
//
//$resultLE = mysqli_query($con, $sqlLE);
//$countrowLE = mysqli_fetch_array($resultLE);
//
//$sqlFK = "SELECT * FROM academic_fk
//JOIN student ON academic_fk.s_ID = student.s_ID
//WHERE student.acc_ID = '$accID' ";
//
//$resultFK = mysqli_query($con, $sqlFK);
//$countrowFK = mysqli_fetch_array($resultFK);
...
<!--                <li class="nav-item"><a class="nav-link active" href="parent_assessment.php"><i class="far fa-user-circle"></i><span>Assessment</span></a></li>-->
