...
<div class="d-sm-flex justify-content-between align-items-center mb-4">
        ...
        <form action="adminvakassessmentfkprocess.php" method="post">
              ...
              <table border="1" cellspacing="0" style="table-layout: fixed;" style="word-wrap: break-word;" width="100%">
                            ...
                            echo'<tr>';
                            echo'<th style="text-align:center" width="30%">Cara Pembelajaran (V.A.K)</th>';
                            
                            foreach($result as $row){
                                if ($row['description'] == "Catatan/Komen")
                                    break;
                                echo '<th style="text-align:center" width="30%" name="acad_VAKType">'.$row['description'].'</th>';
                          ...
                          <tr>
                            ...
                            <td><textarea type="text" class="form-control" style="white-space: normal;" style="width: fit-content;" style="height: fit-content;" name="acad_VAKComm_V" placeholder="Leave a comment" required></textarea></td> 
                              <td></td>
                              <td></td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td style="text-align:center">A: Mendengar/Audio/Bunyi</td>
                                <td></td> 
                                <td><textarea type="text" class="form-control" style="white-space: normal;" style="width: fit-content;" style="height: fit-content;" name="acad_VAKComm_A" placeholder="Leave a comment" required></textarea></td>
                              <td></td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td style="text-align:center">K: Tubuh badan/Pergerakan aktif</td>
                                <td></td> 
                                <td></td>
                                <td><textarea type="text" class="form-control" style="white-space: normal;" style="width: fit-content;" style="height: fit-content;" name="acad_VAKComm_K" placeholder="Leave a comment" required></textarea></td>
                          </tr>
                      </table>
                      <br>
                      ...
                      <table border="1" cellspacing="0" style="table-layout: fixed;" style="word-wrap: break-word;" width="100%">
                        ...
                        <?php
                            ...
                            foreach($result as $row){
                                if ($row['description'] == "Catatan/Komen")
                                 echo '<th style="text-align:center" width="25%">'.$row['description'].'</th>';

                            }
                            
                            ?>
                            
                            <td><textarea type="text" class="form-control" style="white-space: normal;" style="width: fit-content;" style="height: fit-content;" name="acad_VAKComm_C" placeholder="Leave a comment" required></textarea></td>
                        </tr>
