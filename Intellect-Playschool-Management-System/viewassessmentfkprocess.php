...
if( mysqli_num_rows($resultVAK)>0){
    header("location:viewvakassessmentfk.php?id=".$aid);
}
if(mysqli_num_rows($resultINT)>0) {
    header("location:viewintelligentassessmentfk.php?id=".$aid);
}
if(mysqli_num_rows($resultSUB)>0) {
    header("location:viewsubjectassessmentfk.php?id=".$aid);
}
