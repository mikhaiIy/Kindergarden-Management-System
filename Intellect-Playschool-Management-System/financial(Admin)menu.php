...
<div id="wrapper">
    ...
    <div class="d-flex flex-column" id="content-wrapper">
        <div id="content">
            ...
            <!--                main-->
            <a class="btn btn-primary" role="button" data-bss-hover-animate="pulse" href="financial(Admin).php" style="width: 249px;height: 141px;margin: 19px;padding: 51px 12px;">Payment</a>
            <a class="btn btn-primary" role="button" data-bss-hover-animate="pulse" href="admin_salary.php" style="width: 249px;height: 141px;margin: 19px;padding: 51px 12px;">Generated Pay Slip</a>
            <a class="btn btn-primary" role="button" data-bss-hover-animate="pulse" href="admin_salary_view.php" style="width: 249px;height: 141px;margin: 19px;padding: 51px 12px;">View Pay Slip</a>
