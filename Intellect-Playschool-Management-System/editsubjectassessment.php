...
<div class="d-sm-flex justify-content-between align-items-center mb-4">
        ...
        <br>
            ...
            <form action="#" method="post">
                ...
                <!-- Ni nanti connect ngan database supaya boleh retrieve -->
                <div class="form-group row">
                        <div class="col-md-12">
                    
                          <li><label for="exampleInputPassword1" class="form-label mt-4">Subject</label></li>
                          <?php
                $sql = "SELECT * FROM academic_subname_desc";
                $result = mysqli_query($con,$sql);
                echo '<select class="form-select" name="acad_SubName" id="exampleSelect1">';
			      		while($row = mysqli_fetch_array($result))
			      		{
			      			echo"<option value = '".$row['acad_SubName']."'>".$row['description']."</option>";
			      		}
			      	echo '</select>';
                ?>
                        </div>
                      ...
                      <div class="form-group row">
                        <div class="col-md-12">
                          <label for="exampleInputPassword1" class="form-label mt-4">Manners</label>
                          <?php
                $sql = "SELECT * FROM academic_subcomm_desc";
                $result = mysqli_query($con,$sql);
                echo '<select class="form-select" name="acad_SubComm" id="exampleSelect1">';
			      		while($row = mysqli_fetch_array($result))
			      		{
			      			echo"<option value = '".$row['acad_SubComm']."'>".$row['acad_SubComm']."</option>";
			      		}
			      	echo '</select>';
                ?>
                        </div>
                      ...
                      <div class="form-group row">
                        <div class="col-md-12">
                          <label for="exampleInputPassword1" class="form-label mt-4">Writing</label>
                          <?php
                $sql = "SELECT * FROM academic_subcomm_desc";
                $result = mysqli_query($con,$sql);
                echo '<select class="form-select" name="acad_SubComm" id="exampleSelect1">';
                ...
                ?>
                      ...
                      <div class="form-group row">
                        <div class="col-md-12">
                          <label for="exampleInputPassword1" class="form-label mt-4">Counting</label>
                          <?php
                $sql = "SELECT * FROM academic_subcomm_desc";
                $result = mysqli_query($con,$sql);
                echo '<select class="form-select" name="acad_SubComm" id="exampleSelect1">';
