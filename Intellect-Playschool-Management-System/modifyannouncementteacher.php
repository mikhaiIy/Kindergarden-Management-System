...
<div class="container">
    ...
    ?>
    <form method="POST" action="modifyannouncementteacherprocess.php" enctype="multipart/form-data">
        <fieldset>
...
<script>
              function confirmDelete(aa_id) {
                Swal.fire({
                  ...
                  if (result.value) {
                    window.location.href = 'modifyannouncementteacherprocess.php?aa_id=' + aa_id;
                  }
                });
