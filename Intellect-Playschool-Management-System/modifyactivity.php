    ...
    <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
        ...
        <div class="sidebar-brand-icon "><img src="img/lLogo.png" style="width: 30px; height: 50px;"></div>
            ...
            <ul class="navbar-nav text-light" id="accordionSidebar">
                ...
                <li class="nav-item"><a class="nav-link" href="admin_attendancemenu.php"><i class="fas fa-table"></i><span>Attendance</span></a></li>
...
<div class="container">
    ...
    ?>
    <form method="POST" action="modifyactivityprocess.php" enctype="multipart/form-data">
        <fieldset>
            <legend class="text-cursive h5 text-red d-block" style="font-size: 35px">Modify an activity</legend>
            <fieldset>
            ...
            <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="cmedia" id="cmedia">
                        <br><br>
