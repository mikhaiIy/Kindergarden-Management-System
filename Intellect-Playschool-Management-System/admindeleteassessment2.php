            ...
            <div class="row"><div class="col-lg-7 col-xl-8"><div class="card shadow mb-4">
                ...
                if($acad_Prog == 1){
                    while($row=mysqli_fetch_array($resultle)){
                        ...
                        echo "<td>";
                        echo "<a href='#' onclick='confirmDelete1()' class='btn btn-danger'>Delete</a>";
                        echo "</td>";
                        echo '</tr>';
                        echo'<script type="text/javascript">
                        function confirmDelete1() {
                          if (confirm("Are you sure you want to delete the assessment?")) {
                            window.location.href = "admindeleteassessmentleprocess.php?id='.$row['acad_ID'].'";
                            }
                        }
                            </script>';
                    }
                    ...
                    while($row=mysqli_fetch_array($resultfk)){
                        ...
                        echo "<td>".$row['acad_CommStat']."</td>";
                        echo "<td>";
                        echo "<a href='#' onclick='confirmDelete2()' class='btn btn-danger'>Delete</a>";
                        echo "</td>";
                        echo '</tr>';
                        echo'<script type="text/javascript">
                        function confirmDelete2() {
                        if (confirm("Are you sure you want to delete the assessment?")) {
                        window.location.href = "admindeleteassessmentfkprocess.php?id='.$row['acad_ID'].'";
                            }
                        }
                            </script>';
                    }
